        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            ...
            @foreach ($subjects as $subject)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    <div class="w-3/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $subject->subject_name }}</div>
                    ...
                    <div class="w-3/12 px-4 py-3 text-sm text-gray-600 tracking-tight">{{ $subject->subject_description }}</div>
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="{{ route('subject.destroy', $subject->id) }}" data-url="{{ route('subject.destroy', $subject->id) }}" class="deletebtn ml-1 bg-gray-600 block p-1 border border-gray-600 rounded-sm">
